    ...
    <div className="h-screen w-full flex flex-col bg-[var(--wa-bg)] overflow-hidden">
      <SignedOut>
        ...
        <div className="min-h-screen flex flex-col relative bg-[#111B21]">
          ...
          {/* Hero */}
          <main className="relative z-10 flex-1 flex flex-col items-center px-6 py-6 md:py-12 text-center overflow-y-auto">
            <div className="flex flex-col items-center my-auto w-full max-w-3xl pt-8 pb-12">
              {/* Pill badge */}
